      ...
      <div className="aiaf-root">
        ...
        <header className="aiaf-header">
          <nav className="aiaf-nav container">
            ...
            <a
              href="#"
              className="aiaf-btn aiaf-btn-cta"
              onClick={(e) => {
                e.preventDefault();
                setModalOpen(true);
              }}
              ...
              {[
                {
                  ...
                  desc: "24/7 AI agents capture every opportunity",
                },
                {
                  icon: (
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                  ...
                  desc: "Reply in 15 seconds vs hours",
                },
                {
                  icon: (
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                  ...
                  desc: "Turn more prospects into customers",
                },
              ].map((item, i) => (
                <motion.div
                  className="aiaf-benefit-card"
                  key={item.title}
                  custom={i}
                  initial="hidden"
                  animate="visible"
                ...
                >
                  <span className="aiaf-benefit-icon" aria-label={item.title}>
                    {item.icon}
                  </span>
                  <div>
              ...
              {[
                {
                  ...
                  desc: "Intelligent voice assistants that handle customer calls, answer questions, and qualify prospects with natural conversation.",
                  features: [
                ...
                },
                {
                  ...
                  desc: "Automated systems that identify, engage, and nurture prospects across multiple channels.",
                  features: [
                ...
                },
                {
                  ...
                  desc: "Seamless scheduling automation that converts conversations into confirmed appointments.",
                  features: [
                ...
                <motion.div
                  ...
                  variants={cardVariants}
                >
                  <div className="aiaf-service-icon" aria-label={item.title}>
                    {item.icon}
                  </div>
                  <h3>{item.title}</h3>
                  <p>{item.desc}</p>
            ...
            <div className="aiaf-steps">
              ...
              <div className="aiaf-step-card">
                ...
                <p>
                  ...
                  voice, integrate with your existing systems, and test
          ...
          <div className="container">
            <div className="aiaf-footer-content">
              <div className="aiaf-footer-section">
                ...
                <p>
                  Transform your business with AI Agents that works 24/7 to
        ...
        <BookDemoModal open={isModalOpen} onClose={() => setModalOpen(false)} />
      </div>
    </>
  );
}
